...
SearchDropDownUI.prototype.eventHandler = async function (el) {
    ...
    _.on(el, "mouseout", this.mouseoutHandler.bind(this));
    _.on(el, "mouseover", this.mouseoverHandler.bind(this));
    _.on(el, "keyup", this.keyupHandler.bind(this, this.inputSelector));
    _.on(el, "keyup", this.autoCompleteInit.bind(this, this.autoCompleteLists));
    _.on(el, "keyup", this.directionKeyEventHandler.bind(this));
};
...
SearchDropDownUI.prototype.autoCompleteInit = function (el) {
